            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div class="lg:col-span-2">
                        <!-- PERBAIKAN: Border diubah agar lebih terlihat -->
                        <div class="bg-[#CBD5E1] p-6 md:p-8 rounded-2xl shadow-lg border-2 border-[#133E87]">
                            <h1 class="text-3xl md:text-4xl font-bold text-black leading-tight mb-4">
                                {{ post.title }}
                            </h1>
                            <div class="flex items-center space-x-6 text-sm text-black mb-6">
                            ...
                            <div class="prose max-w-none text-black" v-html="post.content"></div>

                            <div class="mt-10 pt-6 border-t border-black flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                <div class="flex items-center gap-1 relative">
                                    ...
                                    <!-- PERBAIKAN: Tombol Twitter ditambahkan -->
                                    ...
                                    <!-- PERBAIKAN: Tombol Instagram ditambahkan -->
